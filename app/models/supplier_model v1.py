...
class Supplier(Base):
    ...
    year_registered: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    # AGPO
    agpo_group: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    agpo_cert_number: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    ...
    contact_person_title: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True
    )
